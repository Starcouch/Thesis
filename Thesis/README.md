...
In addition to global performance metrics, error analysis across demographic subgroups was conducted to assess model behavior and potential performance disparities. In addition to coefficient-based and feature-importance analysis, SHAP values were used as an optional extension to provide model-agnostic explanations for the Random Forest model.
...
├── app/
│   └── streamlit_app.py # Optional Streamlit dashboard for model demonstration
│
├── src/
...
- As an optional extension, SHAP values were used to provide model-agnostic explanations for the Random Forest model.
- A simple Streamlit-based dashboard is included as an optional extension to demonstrate the trained model interactively and support non-technical exploration of predictions.  
...
```
- Run coefficient-based and feature-importance interpretability analysis
```
python src/interpretability.py
```
- Run SHAP-based interpretability analysis for the Random Forest model
```
python src/shap_analysis.py
```
- Run the Streamlit dashboard for interactive model demonstration
```
